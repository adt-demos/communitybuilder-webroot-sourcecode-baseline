...
define( 'CBLIB', '2.6.4' );	// IMPORTANT: when changing version here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just below
...
class CBLib
{
	protected static $THISCBVERSION		=	'2.6.4';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	...
	protected static $supportedVersions	=	array(	'php'		=>	array( 'min' => '7.4.0',	'rec' => '8.0.9' ),	// Joomla minimum is 7.2.5, we need 7.4.0 for numerous features
													...
													'joomla'	=>	array( 'min' => '3.9.0',	'rec' => '3.9.28' )
												);
