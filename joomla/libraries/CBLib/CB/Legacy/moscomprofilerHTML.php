...
abstract class moscomprofilerHTML
{
	...
	public static function selectList( $arr, $tagName, $tagAttributes = '', $key = 'value', $text = 'text', $selected = null, $required = 0, $htmlspecialcharText = true, $addBlank = null, $translate = true )
	{
		...
		if ( ( Application::Application()->isClient( 'administrator' ) && ( Application::Config()->getInt( 'backendTemplateBootstrap4', 1 ) === 2 ) )
			 || ( ( ! Application::Application()->isClient( 'administrator' ) ) && ( Application::Config()->getInt( 'templateBootstrap4', 1 ) === 2 ) ) )
		{
			// convert form-control from bs4 to bs5 form-select to avoid needing 300+ lines of CSS for compatibility
			$tagAttributes			=	str_replace( 'form-control', 'form-select', $tagAttributes );
		}
