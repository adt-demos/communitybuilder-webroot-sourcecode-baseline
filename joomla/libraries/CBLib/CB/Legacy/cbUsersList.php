...
class cbUsersList
{
	 ...
	 * @return void
	 */
	public function drawUsersList( $userId, $listId, $postData, array $paramsData = [] )
	{
		...
		HTML_comprofiler::usersList( $row, $params, $users, $columns, $fields, $input, $search, $searchMode, $pageNav, $user, $searchableFields, $searchValues, $tabs, $errorMsg, $listAll, $random );
	}
