		...
		<fieldset class="userdata">
			<p id="form-login-username">
				<?php if ( in_array( $showUsernameLabel, array( 1, 2, 3, 5 ) ) ) { ?>
					...
					<?php } ?>
				<?php } ?>
				<input id="modlgn-username" type="<?php echo ( $loginMethod === 2 ? 'email' : 'text' ); ?>" name="username" class="<?php echo ( $styleUsername ? htmlspecialchars( $styleUsername ) : 'inputbox' ); ?>" size="<?php echo $usernameInputLength; ?>"<?php echo ( in_array( $showUsernameLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( $userNameText ) . '"' : null ); ?> />
			</p>
