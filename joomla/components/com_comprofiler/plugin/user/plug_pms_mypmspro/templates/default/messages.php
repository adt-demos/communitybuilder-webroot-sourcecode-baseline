...
?>
<div class="pmMessages pmMessagesDefault">
	...
	<?php } ?>
	<div class="mb-3 row no-gutters pkbHeader pmMessagesHeader">
		...
		<div class="col-12 col-sm-6 text-center text-sm-left">
			...
			<button type="button" onclick="window.location.href='<?php echo $_CB_framework->pluginClassUrl( $this->element, true, array( 'action' => 'messages', 'func' => 'new', 'return' => $returnUrl ) ); ?>';" class="btn btn-sm-block btn-success pmButton pmButtonNew"><span class="fa fa-plus-circle"></span> <?php echo CBTxt::T( 'Create New Message' ); ?></button>
			<?php } ?>
			<?php if ( ( $type !== 'sent' ) && $unread ) { ?>
			<a href="<?php echo $_CB_framework->pluginClassUrl( $this->element, true, [ 'action' => 'message', 'func' => 'read', 'return' => $returnUrl ] ); ?>" class="align-middle pmButton pmButtonRead"><?php echo CBTxt::T( 'Mark All Read' ); ?></a>
			<?php } ?>
		</div>
		<?php } ?>
		<?php if ( $input['search'] || $input['type'] ) { ?>
		<div class="col-12 col-sm-6 mt-2 mt-sm-0 text-sm-right" role="search">
			<form action="<?php echo $_CB_framework->pluginClassUrl( $this->element, true, [ 'action' => 'messages', 'func' => ( ! $allowTypeFilter ? $type : null ) ] ); ?>" method="post" name="pmMessagesForm" class="m-0 pmMessagesForm">
	...
	<div class="pmMessagesRows" role="grid">
		<?php
		$i							=	0;
	...
	<div class="mt-2 pmMessagesPaging">
