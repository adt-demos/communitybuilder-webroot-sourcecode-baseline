...
class plgsystemcommunitybuilderInstallerScript {
	...
	public function install( /** @noinspection PhpUnusedParameterInspection */ $adapter ) {
		...
		$plugin				=	( Version::MAJOR_VERSION >= 6 ? new Extension( $db ) : Table::getInstance( 'extension' ) );
		...
		$legacy				=	( Version::MAJOR_VERSION >= 6 ? new Extension( $db ) : Table::getInstance( 'extension' ) );
